...
function Page() {
  return (
    <Layout>
      <div
        className="p-8 w-full bg-fabl-indigo-dark/20 flex flex-col items-center py-36 text-center"
        style={{
          backgroundSize: "70px",
      ...
      >
        <img src="/FABL_IconLogo.svg" className="h-40 aspect-square" />
        <div className="text-5xl mt-4 mb-2 font-bold flex items-center gap-3">
          <span>Welcome to</span>
          <img src="/FABL_TextLogo.svg" className="h-9" />
        </div>
